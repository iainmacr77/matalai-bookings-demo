    ...
    <footer className="bg-black text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-semibold mb-4">Matalai</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-400 hover:text-white">Lodges & Camps</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>+27 (0) 21 683 3424</li>
              <li>reservations@matalai.com</li>
              <li>PO Box 1234</li>
          ...
          <div>
            ...
            <form className="flex">
              ...
              <button
                type="submit"
                className="bg-white text-black px-4 py-2 rounded-r-md hover:bg-gray-100"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Matalai. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
